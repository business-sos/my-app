...
// ─── AI DETECTION AVOIDANCE (from AgriciDaniel/claude-blog blog-analyzer) ─────
// Applied to ALL generation calls regardless of skill selection.
// Based on 3 detection signals: burstiness, 18 flagged phrases, vocabulary diversity.
function antiAICtx() {
  return `ANTI-AI-DETECTION — APPLY TO EVERY POST:
Sentence burstiness: Mix lengths deliberately. Short hits hard. Then a longer sentence carries the reader through a shift in thinking before you drop back down. Never write five sentences in a row of similar length — that's the top AI tell.
Banned phrases — never use: "In today's digital landscape", "It's important to note", "Furthermore", "Moreover", "Additionally", "In conclusion", "Leverage" (as verb), "Delve into", "Tapestry", "Multifaceted", "Nuanced approach", "Unlock", "Groundbreaking", "Paradigm shift", "Robust", "Streamline", "Seamless", "Holistic", "Navigate", "Comprehensive", "It is worth noting", "At the end of the day", "Moving forward", "Touch base", "Circle back".
Vocabulary diversity: Never repeat the same descriptive word or phrase twice in a post. Find a different construction each time.
No robotic transitions: Don't bridge paragraphs with transition words. Let ideas connect through logic, not signposting.
Zero em dashes: Replace every em dash with a comma, colon, hyphen, or period.
Natural contractions: Use don't, it's, you'll, they're, that's where natural. Stiff formal language is an AI tell.
Hedging where genuine: Occasionally "tends to", "in most cases", "usually" sounds human. Absolute claims on everything reads as machine-generated.`;
}
